...
export const modal = tv({
  slots: {
    base: "backdrop:bg-black/80 min-h-fit max-h-screen open:flex flex-col w-full rounded-lg divide-y text-gray-500 dark:text-gray-400 border-gray-300 dark:border-gray-800 divide-gray-300 dark:divide-gray-700 bg-white dark:bg-gray-800 pointer-events-auto",
