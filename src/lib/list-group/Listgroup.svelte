...
<svelte:element this={tag} data-scope="list-group" data-part="base" {...restProps} class={base({ class: clsx(theme?.base, className) })}>
  {#if items?.length}
...
## Type
[ListgroupProps](https://github.com/themesberg/flowbite-svelte/blob/main/src/lib/types.ts#L1038)
## Props
@prop children
@prop items
@prop active
