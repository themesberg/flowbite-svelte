...
<div role="status" class={outDivclass}>
  ...
  <div class="mt-4 flex items-center space-x-3 rtl:space-x-reverse">
    <svg class="h-14 w-14 text-gray-200 dark:text-gray-700" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      <path
        fill-rule="evenodd"
