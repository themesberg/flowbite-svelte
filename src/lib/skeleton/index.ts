import type { CardPlaceholderProps, ImagePlaceholderProps, ListPlaceholderProps, SkeletonProps, SizeVideoType, TextPlaceholderProps, VideoPlaceholderProps } from "./type";
