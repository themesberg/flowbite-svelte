<script lang="ts">
  ...
  let divCls: string = twMerge('space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center', divclass);
</script>

<div role="status" class={divCls}>
  <div class="flex w-full items-center justify-center {imgHeight} rounded bg-gray-300 dark:bg-gray-700 sm:w-96">
...
## Props
@props: imgHeight?: string | undefined;
