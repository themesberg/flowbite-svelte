<script lang="ts">
  ...
  let { children, toggleNav, closeNav, openMainMenu = true, navStatus, fluid, brand, breakPoint = 'md', navclass, divclass, btnclass, div2class, activeClass, nonActiveClass, ...attributes } = $props<Props>();
