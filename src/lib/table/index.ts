import type { TableProps, TableCtxType, TableHeadProps, HeadItemType, TableBodyRowProps, TableBodyCellProps, BodyRow, CellValue, TableBodyProps, TableHeadCellProps, TableSearchProps, TableSearchType, TableItemType } from "./type";
