<script lang="ts">
  ...
  export let svgDivClass: string = 'absolute inset-y-0 left-0 flex items-center ps-3 pointer-events-none';
...
@prop export let svgDivClass: string = 'absolute inset-y-0 left-0 flex items-center ps-3 pointer-events-none';
