...
export const datepicker = tv({
  ...
  variants: {
    color: {
      ...
      dark: { input: "focus:ring-dark-500 dark:focus:ring-dark-400", dayButton: "bg-dark-100 dark:bg-dark-900" },
      light: { input: "focus:ring-light-500 dark:focus:ring-light-400", dayButton: "bg-light-100 dark:bg-light-900" },
