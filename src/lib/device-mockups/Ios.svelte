<script lang="ts">
  ...
  export let leftTop: string = 'h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[124px] rounded-l-lg';
  export let leftBot: string = 'h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[178px] rounded-l-lg';
  export let right: string = 'h-[64px] w-[3px] bg-gray-800 absolute -end-[17px] top-[142px] rounded-r-lg';
</script>
...
@prop export let leftTop: string = 'h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[124px] rounded-l-lg';
@prop export let leftBot: string = 'h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[178px] rounded-l-lg';
@prop export let right: string = 'h-[64px] w-[3px] bg-gray-800 absolute -end-[17px] top-[142px] rounded-r-lg';
-->
