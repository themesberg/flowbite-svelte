<script lang="ts">
  ...
  export let labelClass: string = 'text-sm font-medium text-blue-600 dark:text-blue-500';
  ...
  export let rightLabelClass: string = 'text-sm font-medium text-blue-600 dark:text-blue-500';
