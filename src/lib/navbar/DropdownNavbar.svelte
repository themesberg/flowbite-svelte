<script lang="ts">
	...
	export let logo: string = '/images/mkdir-logo.png';
	...
	export let dropdownDiv: string = 'z-10 w-44 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600';
