<script lang="ts">
  ...
  const colors = {
    ...
    dark: 'peer-focus:ring-gray-300 dark:peer-focus:ring-gray-800 peer-checked:bg-gray-700',
    black: 'peer-focus:ring-black-300 dark:peer-focus:ring-black-800 peer-checked:bg-black-900'
  };
