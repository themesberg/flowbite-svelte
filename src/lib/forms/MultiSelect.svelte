<script lang="ts">
  ...
  const multiSelectClass: string =
    'relative p-2 text-gray-900 bg-gray-50 border border-gray-300 flex items-center rounded-lg gap-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:border-2 dark:focus:border-2 focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 dark:focus:ring-primary-500';
  // Pills Button
