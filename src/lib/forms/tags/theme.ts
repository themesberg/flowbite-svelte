...
export const tags = tv({
  slots: {
    ...
    close: "my-auto ml-1",
    input:
      "block text-sm my-1 mx-2.5 p-0 bg-transparent border-none outline-none text-heading w-full min-w-fit focus:ring-0 placeholder:text-body disabled:cursor-not-allowed disabled:opacity-50",
