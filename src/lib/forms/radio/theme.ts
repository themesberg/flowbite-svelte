...
export const radio = tv({
  ...
  variants: {
    color: {
      ...
      emerald: {
        input:
          'text-emerald-600 focus:ring-emerald-500 dark:focus:ring-emerald-600'
      },
      teal: {
      ...
      indigo: {
        input:
          'text-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600'
      },
      violet: {
        input:
          'text-violet-600 focus:ring-violet-500 dark:focus:ring-violet-600'
      },
      purple: {
        input:
      ...
      fuchsia: {
        input:
          'text-fuchsia-600 focus:ring-fuchsia-500 dark:focus:ring-fuchsia-600'
      },
      pink: {
