<script lang="ts">
  ...
  let { children, id = idGenerator(), value = $bindable(), aria_describedby, inputStyle = "standard", size = "default", color = "default", divClass, inputClass, labelClass, ...restProps }: Props = $props();
