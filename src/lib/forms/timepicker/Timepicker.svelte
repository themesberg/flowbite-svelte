  ...
  <ButtonGroup {size} class={cn(styles.buttonGroup(), divClass, (theme as TimepickerTheme)?.buttonGroup)}>
    {#if type === "default"}
      <Input 
        ...
        {required} 
        {disabled} 
        class={cn(styles.input(), styles.inputWithIcon(), inputClass, (theme as TimepickerTheme)?.input)} 
        bind:value 
    ...
    {:else if type === "select"}
      <Input 
        ...
        {required} 
        {disabled} 
        class={cn(styles.input(), inputClass, (theme as TimepickerTheme)?.input)} 
        bind:value 
        oninput={(e) => handleTimeChange(e)} 
        onchange={(e) => handleTimeChange(e)} 
      />
      <Select 
        selectClass={cn(styles.select(), selectClass, (theme as TimepickerTheme)?.select)} 
    ...
    {:else if type === "range"}
      <div class={cn(styles.rangeInputWrapper(), (theme as TimepickerTheme)?.rangeInputWrapper)}>
        <Input 
          ...
          {required} 
          {disabled} 
          class={cn(styles.input(), styles.rangeInput(), inputClass, (theme as TimepickerTheme)?.rangeInput)} 
          bind:value 
          oninput={(e) => handleTimeChange(e)} 
          onchange={(e) => handleTimeChange(e)} 
        />
        <button 
          type="button" 
          class={cn(styles.rangeButton(), (theme as TimepickerTheme)?.rangeButton)} 
          ...
          <div class={cn(styles.dropdownTimeRow(), (theme as TimepickerTheme)?.dropdownTimeRow)}>
            <div class={cn(styles.dropdownTimeCol(), (theme as TimepickerTheme)?.dropdownTimeCol)}>
              ...
              <Input 
                ...
                {required} 
                {disabled} 
                class={cn(styles.dropdownTimeInput(), inputClass, (theme as TimepickerTheme)?.dropdownTimeInput)} 
                bind:value 
                oninput={(e) => handleTimeChange(e)} 
                onchange={(e) => handleTimeChange(e)} 
              />
          ...
          <div class={cn(styles.toggleTimeRow(), (theme as TimepickerTheme)?.toggleTimeRow)}>
            <div class={cn(styles.toggleTimeCol(), (theme as TimepickerTheme)?.toggleTimeCol)}>
              ...
              <Input 
                ...
                {required} 
                {disabled} 
                class={cn(styles.toggleTimeInput(), inputClass, (theme as TimepickerTheme)?.toggleTimeInput)} 
                bind:value 
                oninput={(e) => handleTimeChange(e)} 
                onchange={(e) => handleTimeChange(e)} 
              />
  ...
  <div class={cn(styles.inlineGrid(), (theme as TimepickerTheme)?.inlineGrid)}>
    {#each timeIntervals as time}
      <Button 
        ...
        class={cn(styles.inlineButton(), (theme as TimepickerTheme)?.inlineButton)} 
