...
const alertVariants = tv({
  ...
  variants: {
    color: {
      ...
      indigo: 'bg-indigo-50 dark:bg-gray-800 text-indigo-800 dark:text-indigo-400',
      pink: 'bg-pink-50 dark:bg-gray-800 text-pink-800 dark:text-pink-400',
      purple: 'bg-purple-50 dark:bg-gray-800 text-purple-800 dark:text-purple-400',
      red: 'bg-red-50 dark:bg-gray-800 text-red-800 dark:text-red-400',
      yellow: 'bg-yellow-50 dark:bg-gray-800 text-yellow-800 dark:text-yellow-300',
      none: ''
    },
    rounded: {
      true: 'rounded-lg'
...
type alertColor = VariantProps<typeof alertVariants>["color"];
