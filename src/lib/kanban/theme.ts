...
export const kanbanBoard = tv({
  slots: {
    ...
    addButton:
      "mt-2 md:mt-3 w-full bg-primary text-primary-foreground rounded-lg py-1.5 text-xs md:text-sm font-medium hover:bg-primary/90 transition-colors focus:ring-2 focus:ring-primary focus:ring-offset-2"
  },
  variants: {
    isDragOver: {
      true: {
