...
{#if active && currentStepData}
  ...
  <!-- Highlight -->
  <div 
    class="{highlightClass ? highlightClass : styles.highlight({ class: clsx(theme?.highlight, classes?.highlight) })} z-[9999]"
  ...
  <div 
    ...
    class="{styles.tooltip({ class: clsx(theme?.tooltip, classes?.tooltip) })} z-[10001]"
    style={tooltipStyle}
  >
    <!-- Arrow -->
    <div
      bind:this={arrowElement}
      class={styles.arrow({ class: clsx(theme?.arrow, classes?.arrow) })}
      style={arrowStyle}
    ...
    <div class={styles.actions({ class: clsx(theme?.actions, classes?.actions) })}>
      <button 
        class="{styles.button({ class: clsx(theme?.button, classes?.button) })} {styles.buttonSecondary()}"
        onclick={skip}
      >
        Skip
      </button>
      ...
      <div class={styles.navigation({ class: clsx(theme?.navigation, classes?.navigation) })}>
        ...
        <button 
          class="{styles.button({ class: clsx(theme?.button, classes?.button) })} {styles.buttonPrimary()}"
          onclick={next}
        >
