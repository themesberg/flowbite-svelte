  ...
  variants: {
    color: {
      ...
      primary: {
        ...
        outline: "text-primary bg-neutral-primary border border-primary enabled:hover:bg-primary enabled:hover:text-white focus:ring-primary-subtle",
      ...
      secondary: {
        ...
        outline: "text-secondary bg-neutral-primary border border-secondary enabled:hover:bg-secondary enabled:hover:text-white focus:ring-secondary-subtle",
      ...
      amber: {
        ...
        outline: "text-amber bg-neutral-primary border border-amber enabled:hover:bg-amber enabled:hover:text-white focus:ring-amber-subtle",
      ...
      blue: {
        ...
        outline: "text-blue bg-neutral-primary border border-blue enabled:hover:bg-blue enabled:hover:text-white focus:ring-blue-subtle",
      ...
      cyan: {
        ...
        outline: "text-cyan bg-neutral-primary border border-cyan enabled:hover:bg-cyan enabled:hover:text-white focus:ring-cyan-subtle",
      ...
      emerald: {
        ...
        outline: "text-emerald bg-neutral-primary border border-emerald enabled:hover:bg-emerald enabled:hover:text-white focus:ring-emerald-subtle",
      ...
      fuchsia: {
        ...
        outline: "text-fuchsia bg-neutral-primary border border-fuchsia enabled:hover:bg-fuchsia enabled:hover:text-white focus:ring-fuchsia-subtle",
      ...
      green: {
        ...
        outline: "text-green bg-neutral-primary border border-green enabled:hover:bg-green enabled:hover:text-white focus:ring-green-subtle",
        shadow: "shadow-green-500/50 dark:shadow-green-800/80"
      },
      indigo: {
        base: "text-white bg-indigo border border-transparent enabled:hover:bg-indigo-strong focus:ring-indigo-medium",
        outline: "text-indigo bg-neutral-primary border border-indigo enabled:hover:bg-indigo enabled:hover:text-white focus:ring-indigo-subtle",
      ...
      lime: {
        ...
        outline: "text-lime bg-neutral-primary border border-lime enabled:hover:bg-lime enabled:hover:text-white focus:ring-lime-subtle",
      ...
      orange: {
        ...
        outline: "text-orange bg-neutral-primary border border-orange enabled:hover:bg-orange enabled:hover:text-white focus:ring-orange-subtle",
      ...
      pink: {
        ...
        outline: "text-pink bg-neutral-primary border border-pink enabled:hover:bg-pink enabled:hover:text-white focus:ring-pink-subtle",
      ...
      purple: {
        ...
        outline: "text-purple bg-neutral-primary border border-purple enabled:hover:bg-purple enabled:hover:text-white focus:ring-purple-subtle",
      ...
      red: {
        ...
        outline: "text-red bg-neutral-primary border border-red enabled:hover:bg-red enabled:hover:text-white focus:ring-red-subtle",
        shadow: "shadow-red-500/50 dark:shadow-red-800/80"
      },
      rose: {
        base: "text-white bg-rose border border-transparent enabled:hover:bg-rose-strong focus:ring-rose-medium",
        outline: "text-rose bg-neutral-primary border border-rose enabled:hover:bg-rose enabled:hover:text-white focus:ring-rose-subtle",
      ...
      sky: {
        ...
        outline: "text-sky bg-neutral-primary border border-sky enabled:hover:bg-sky enabled:hover:text-white focus:ring-sky-subtle",
      ...
      teal: {
        ...
        outline: "text-teal bg-neutral-primary border border-teal enabled:hover:bg-teal enabled:hover:text-white focus:ring-teal-subtle",
      ...
      violet: {
        ...
        outline: "text-violet bg-neutral-primary border border-violet enabled:hover:bg-violet enabled:hover:text-white focus:ring-violet-subtle",
      ...
      yellow: {
        ...
        outline: "text-yellow bg-neutral-primary border border-yellow enabled:hover:bg-yellow enabled:hover:text-white focus:ring-yellow-subtle",
        shadow: "shadow-yellow-500/50 dark:shadow-yellow-800/80"
      }
    },
    size: {
