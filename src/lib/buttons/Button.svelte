<script lang="ts">
	...
	export let buttonColor: Buttontypes = 'blue';
	...
	} else if (buttonColor === 'blue-outline') {
	...
	} else if (buttonColor === 'dark-outline') {
	...
	} else if (buttonColor === 'green-outline') {
	...
	} else if (buttonColor === 'red-outline') {
	...
	} else if (buttonColor === 'yellow-outline') {
	...
	} else if (buttonColor === 'purple-outline') {
