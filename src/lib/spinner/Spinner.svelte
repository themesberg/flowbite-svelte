...
<svg {...attributes} role="status" class={twMerge('-mt-px inline animate-spin dark:text-gray-600', iconsize, bg, fillColorCls, svgclass)} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
