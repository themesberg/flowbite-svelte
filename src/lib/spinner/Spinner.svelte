<script lang="ts">
    ...
    let { class: classname, color = 'primary', bg = 'text-gray-300', customColor, size = '8', currentFill = 'currentFill', currentColor = 'currentColor', ...attributes }= $props<Props>();
  ...
  <svg {...attributes} role="status" class={twMerge('inline -mt-px animate-spin dark:text-gray-600', iconsize, bg, fillColorClass, classname)} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
