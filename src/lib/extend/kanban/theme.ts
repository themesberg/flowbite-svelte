...
export const kanbanBoard = tv({
  slots: {
    ...
    button:
      "mt-2 md:mt-3 w-full bg-brand text-white rounded-lg py-1.5 text-xs md:text-sm font-medium hover:bg-brand-strong transition-colors focus:ring-2 focus:ring-brand focus:ring-offset-2"
  },
  variants: {
    isDragOver: {
      true: {
