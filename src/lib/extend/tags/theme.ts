...
export const tags = tv({
  slots: {
    ...
    label: "items-center",
    close: "my-auto ml-1",
    input: "block text-sm m-2.5 p-0 bg-transparent border-none outline-none text-heading h-min w-full min-w-fit focus:ring-0 placeholder:text-body disabled:cursor-not-allowed disabled:opacity-50",
