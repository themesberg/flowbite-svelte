...
<svg role="status" class={twMerge('inline -mt-px animate-spin dark:text-gray-600', iconsize, bg, fillColorClass, $$props.class)} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
