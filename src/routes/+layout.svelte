...
<div class="mx-auto">
  ...
  <Navbar navClass="px-2 pt-2 lg:pt-4 fixed w-full mx-auto z-20 top-11 left-0 border-b" let:hidden let:toggle>
  ...
  <Drawer
    ...
    divClass='overflow-y-auto z-10 p-4 bg-white dark:bg-gray-900'>
