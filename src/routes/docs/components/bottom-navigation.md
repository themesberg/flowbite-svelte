...
- Use the `classOuter` attribute to overwrite a class in the `outerClass`.
- Use the `classInner` attribute to overwrite a class in the `innerClass`.
...
- Use the `class` attribute to overwrite a class in the `defaultClass` or `activeClass`.
