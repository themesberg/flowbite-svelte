...
{#if $drawerHidden}
  <div
    class="fixed inset-0 bg-gray-900/50 dark:bg-gray-900/60"
    on:click={closeDrawer}
    on:keydown={closeDrawer} />

  <Sidebar
    asideClass="fixed inset-0 flex-none h-full w-64 lg:static lg:h-auto border-r border-gray-200 dark:border-gray-600 lg:overflow-y-visible lg:pt-0 lg:block lg:sticky top-24 lg:top-28">
