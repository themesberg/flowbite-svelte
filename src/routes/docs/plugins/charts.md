  ...
  <div class="flex justify-between items-start w-full">
    ...
    <div class="flex justify-end items-center">
      ...
      <Dropdown triggeredBy="#dots-menu" class="w-44" offset="-6">
        <DropdownItem><Icon name="pen-solid" class="inline w-3 h-3 mr-2" /> Edit widget</DropdownItem>
        <DropdownItem><Icon name="download-solid" class="inline w-3 h-3 mr-2" />Dropdown data</DropdownItem>
        <DropdownItem><Icon name="share-nodes-solid" class="inline w-3 h-3 mr-2" />Add to repository</DropdownItem>
        <DropdownItem><Icon name="trash-bin-solid" class="inline w-3 h-3 mr-2" />Delete widget</DropdownItem>
      </Dropdown>
    </div>
  </div>
