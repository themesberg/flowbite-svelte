...
<h1 class="text-3xl my-4">Device Mockups</h1>

<div class="my-8">
  <h2 class="text-2xl my-4">Default mockup</h2>
  <DeviceMockup>
...
<div class="my-8">
  <h2 class="text-2xl my-4">iPhone 12 mockup (iOS)</h2>
...
<div class="my-8">
  <h2 class="text-2xl my-4">Google Pixel mockup (Android)</h2>
...
<div class="my-8">
  <h2 class="text-2xl my-4">Tablet mockup</h2>
...
<div class="my-8">
  <h2 class="text-2xl my-4">Laptop mockup</h2>
...
<div class="my-8">
  <h2 class="text-2xl my-4">Desktop mockup</h2>
...
<div class="my-8">
  <h2 class="text-2xl my-4">Smartwatch mockup</h2>
