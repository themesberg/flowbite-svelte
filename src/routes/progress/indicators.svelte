...
<h1 class="text-3xl my-4">Svelte Indicators</h1>

<h2 class="text-2xl my-4">Setup</h2>
<div class="my-4"></div>

<h2 class="text-2xl my-4">Default indicator</h2>
...
<h2 class="text-2xl my-4">Legend indicator</h2>
<div class="text-sm font-medium text-gray-900 dark:text-white flex gap-2 my-4">
...
<h2 class="text-2xl my-4">Indicator count</h2>
...
<h2 class="text-2xl my-4">Status indicator</h2>
<div class="flex gap-2 my-4">
...
<h2 class="text-2xl my-4">Badge indicator</h2>
<div class="flex gap-2 my-4">
...
<h2 class="text-2xl my-4">Stepper indicator</h2>
...
<h2 class="text-2xl my-4">Indicator position</h2>
