...
<h2 class="text-2xl my-4">Controls</h2>
<div class="max-w-4xl">
  <Carousel {images}>
    <Controls />
  </Carousel>
...
<h2 class="text-2xl my-4">Indicators</h2>
<div class="max-w-4xl">
  <Carousel {images}>
    <Indicators />
  </Carousel>
...
<div class="max-w-4xl space-y-4">
  ...
  <Thumbnails {images} bind:index={index} />
</div>

<h2 class="text-2xl my-4">Caption</h2>
<div class="max-w-4xl space-y-4">
...
<h2 class="text-2xl my-4">Carousel with links</h2>
<div class="max-w-4xl space-y-4">
...
<h2 class="text-2xl my-4">Customization</h2>

<h3 class="text-xl my-2">Basic customization</h3>
<div class="max-w-4xl space-y-4">
  <Carousel
    {images}
    imgClass="object-contain h-full w-fit rounded-xs"
    class="min-h-[320px] rounded-md border-4 border-white bg-gray-200 ring-4 ring-green-500 dark:border-gray-800"
  >
...
<h3 class="text-xl my-2">Advanced customization</h3>
<div class="max-w-4xl space-y-4">
  <Carousel {images} bind:index>
    <Indicators>
    ...
    <Controls>
      {#snippet children(changeSlide)}
        <ControlButton
          ...
          class="bg-red-300/50 dark:bg-red-400/50"
        />
        <Button
          pill
...
<h3 class="text-xl my-2">Custom Carousel transition</h3>
<div class="max-w-4xl">
