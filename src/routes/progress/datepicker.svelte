...
<h1 class="text-3xl my-4">Datepicker</h1>

<h2 class="text-2xl my-4">Default Datepicker</h2>
...
<h2 class="text-2xl my-4">Date Range Selection</h2>
<div class="mb-64 md:w-1/2">
...
<h2 class="text-2xl my-4">Inline Datepicker</h2>
<div class="md:w-1/2">
...
<h2 class="text-2xl my-4">Localization</h2>
<div class="mb-64 md:w-1/2">
  <Datepicker locale="fr-FR" />
</div>

<h2 class="text-2xl my-4">Custom Date Format</h2>
<div class="mb-64 md:w-1/2">
  <Datepicker dateFormat={{ year: "numeric", month: "short", day: "2-digit" }} />
</div>

<h2 class="text-2xl my-4">Action Buttons</h2>
<div class="mb-64 md:w-1/2">
...
<h2 class="text-2xl my-4">Custom Title</h2>
<div class="mb-64 md:w-1/2">
...
<h2 class="text-2xl my-4">Required Field</h2>
<div class="mb-64 md:w-1/2">
  <Datepicker required />
</div>

<h2 class="text-2xl my-4">Custom First Day of Week</h2>
<div class="mb-64 md:w-1/2">
  <Datepicker firstDayOfWeek={3} />
</div>

<h2 class="text-2xl my-4">Event Handling</h2>
<div class="mb-64 md:w-1/2">
