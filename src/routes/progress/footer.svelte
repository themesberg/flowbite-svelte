...
<h1 class="text-3xl my-4">Footer</h1>

<h2 class="text-2xl my-4">Default footer</h2>
...
<h2 class="text-2xl my-4">Footer with logo</h2>
...
<h2 class="text-2xl my-4">Social media icons</h2>
...
<h2 class="text-2xl my-4">Sitemap links</h2>
...
<h2 class="text-2xl my-4">Sticky footer</h2>

<div class="example-container mb-8 relative">
