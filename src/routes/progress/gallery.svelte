...
<h1 class="text-3xl my-4">Svelte Gallery (Masonry)</h1>

<div class="default-gallery-section">
  <h2 class="text-2xl my-4">Default gallery</h2>
  <Gallery items={images} class="grid-cols-2 gap-4 md:grid-cols-3" />
</div>

<div class="masonry-grid-section">
  <h2 class="text-2xl my-4">Masonry grid</h2>
...
<div class="featured-image-section">
  <h2 class="text-2xl my-4">Featured image</h2>
  <Gallery class="gap-4">
...
<div class="quad-gallery-section">
  <h2 class="text-2xl my-4">Quad gallery</h2>
  <Gallery class="grid-cols-2 gap-2" items={quadImages} />
</div>

<div class="gallery-with-filters-section">
  <h2 class="text-2xl my-4">Gallery with tag filters</h2>
...
<div class="heterogeneous-gallery-section">
  <h2 class="text-2xl my-4">Heterogeneous gallery</h2>
...
<div class="custom-image-rendering-section">
  <h2 class="text-2xl my-4">Custom image rendering</h2>
