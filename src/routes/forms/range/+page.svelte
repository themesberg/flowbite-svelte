...
<CodeWrapper>
  <div class="relative">
    ...
    <span class="text-sm text-gray-500 dark:text-gray-400 absolute start-1/2 -translate-x-1/2 rtl:translate-x-1/2 -bottom-6">{minmax.max/2}</span>
    <span class="text-sm text-gray-500 dark:text-gray-400 absolute end-0 -bottom-6">Max: {minmax.max}</span>
    {/if}
  </div>
  <div class="flex flex-wrap space-x-2 mt-12 mb-4">
...
<CodeWrapper class="space-y-6">
  ...
  <Range id="small-range" rangeSize={rangeSize} />
