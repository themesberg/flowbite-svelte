...
<HighlightCompo code={modules['./md/checkbox-examples.md']} />
...
<HighlightCompo code={modules['./md/checkbox-with-a-link.md']} />
...
<HighlightCompo code={modules['./md/checkbox-list-group.md']} />
