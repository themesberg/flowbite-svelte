const brownPaper = `<style>pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}.hljs{color:#363c69;background:#b7a68e url(./brown-papersq.png)}.hljs-keyword,
.hljs-selector-tag,
