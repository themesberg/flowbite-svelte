<script lang="ts">
  import { ButtonGroup, buttonGroup, Button, button, Label, Radio, type ButtonGroupProps, uiHelpers, type ButtonProps } from "$lib";
...
<CodeWrapper>
  ...
  <div class="mb-4 flex flex-wrap space-x-2">
    ...
    {#each colors as colorOption}
      <Radio class="my-1" classes={{ label: "w-24" }} name="color" bind:group={color} value={colorOption}>{colorOption}</Radio>
    {/each}
  </div>
