...
<div class="max-w-4xl mx-auto">
	<div class="container mx-auto p-8 m-4">
		...
		<h2 class="px-8 m-4 text-xl">Rounded</h2>
		<Button name="Button text-xs" textSize="text-xs" rounded />
		<Button name="Button text-xs" textSize="text-xs" type="dark" rounded />
		<Button name="Button text-xs" textSize="text-xs" type="light" rounded />
		<Button name="Button text-xs" textSize="text-xs" type="green" rounded />
		<Button name="Button text-xs" textSize="text-xs" type="red" rounded />
		<Button name="Button text-xs" textSize="text-xs" type="yellow" rounded />
		<Button name="Button text-xs" textSize="text-xs" type="purple" rounded />

		<h2 class="px-8 m-4 text-xl">Outlined</h2>
	...
	<div class="container mx-auto p-8 m-4">
		<h1 class="px-8  text-2xl">Text size sm</h1>
		<h2 class="px-8 m-4 text-xl">Default</h2>
		...
		<h2 class="px-8 m-4 text-xl">Rounded</h2>
		<Button name="Button" textSize="text-sm" rounded />
		<Button name="Button" textSize="text-sm" type="dark" rounded />
		<Button name="Button" textSize="text-sm" type="light" rounded />
		<Button name="Button" textSize="text-sm" type="green" rounded />
		<Button name="Button" textSize="text-sm" type="red" rounded />
		<Button name="Button" textSize="text-sm" type="yellow" rounded />
		<Button name="Button" textSize="text-sm" type="purple" rounded />
	...
	<div class="container mx-auto p-8 m-4">
		<h1 class="px-8  text-2xl">Text size base</h1>
		<h2 class="px-8 m-4 text-xl">Default</h2>
		...
		<h2 class="px-8 m-4 text-xl">Rounded</h2>
		<Button name="Button" textSize="text-base" rounded />
		<Button name="Button" textSize="text-base" type="dark" rounded />
		<Button name="Button" textSize="text-base" type="light" rounded />
		<Button name="Button" textSize="text-base" type="green" rounded />
		<Button name="Button" textSize="text-base" type="red" rounded />
		<Button name="Button" textSize="text-base" type="yellow" rounded />
		<Button name="Button" textSize="text-base" type="purple" rounded />
