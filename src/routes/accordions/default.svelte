		...
		<AccordionItem id="1">
			...
			<div slot="body">
				<p class="mb-2 text-gray-500 dark:text-gray-400">
					...
					explicabo, atque temporibus rem iusto, dicta voluptatem molestias ex quibusdam ipsa omnis
					laboriosam deleniti ipsum nisi quis perspiciatis.
				</p>
		...
		<AccordionItem id="2">
			...
			<div slot="body">
				...
				<ul class="list-disc pl-5 dark:text-gray-400 text-gray-500">
					<li>
						<a href="/" target="_blank" class="text-blue-600 dark:text-blue-500 hover:underline"
							>Lorem ipsum</a
						>
					</li>
					<li>
