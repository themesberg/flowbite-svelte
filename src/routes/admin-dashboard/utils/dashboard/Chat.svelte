...
<Card size="xl" class="p-4 sm:p-6">
  ...
  <form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
    <ChatMsg replays={4} name={Users[2].name} avatar={imagesPath(Users[2].avatar, 'users')}>
      <p>
        Hello <a href="#top" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@designteam</a> Let's schedule a kick-off meeting and workshop this week. It would be great to gather
    ...
    <ChatMsg replays={0} name={Users[4].name} avatar={imagesPath(Users[4].avatar, 'users')}>
      <p>Hello everyone,</p>
      <p>
        Thank you for the workshop, it was very productive meeting. I can't wait to start working on this new project with you guys. But first things first, I'am waiting for the offer and pitch deck
        from you. It would be great to get it by the end o the month.
      </p>
      <p>Cheers!</p>
    ...
    <ChatMsg replays={0} name={Users[3].name} avatar={imagesPath(Users[3].avatar, 'users')}>
      <p>
        Ok <a href="#top" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@team</a> I'am attaching our offer and pitch deck. Take your time to review everything. I'am looking
    ...
    <ChatMsg replays={0} name={Users[8].name} avatar={imagesPath(Users[8].avatar, 'users')} class="pl-12">
      <p>
        Hello <a href="#top" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@jeseleos</a> I need some informations about flowbite react version.
      </p>
    </ChatMsg>
    <ChatMsg replays={0} name={Users[3].name} avatar={imagesPath(Users[3].avatar, 'users')} class="pl-12">
      <p class="mb-5">
        Hi <a href="#top" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">@josephh</a> Sure, just let me know whean you are available and we can speak.
      </p>
