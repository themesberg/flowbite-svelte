<script lang="ts">
  ...
  import { ArrowLeftOutline, ArrowRightOutline, CheckCircleSolid, CheckOutline, FireSolid, LayersSolid, RocketSolid } from 'flowbite-svelte-icons';
    ...
    <div slot="slide" let:index>
      ...
      {:else if index == 1}
        <div in:fly={transitionSlideIn} out:fly={transitionSlideOut} class="h-full">
          ...
          <a href="#top" class="inline-flex items-center rounded-lg p-2 font-medium text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700">
