<script module lang="ts">
  ...
  const bgColors = {
    ...
    navUl: "bg-gray-50 dark:bg-gray-800",
...
<script lang="ts">
  ...
  const textColors = {
    ...
    navUl: "text-gray-700 dark:text-gray-300",
  ...
  const borderColors = {
    ...
    navUl: "border-gray-100 dark:border-gray-700 divide-gray-100 dark:divide-gray-700",
  ...
  let divClass: string = $derived(twMerge(bgColors[color], textColors[color], rounded && "rounded-lg", border && "border", borderColors[color], shadow && "shadow-md", className));
</script>
