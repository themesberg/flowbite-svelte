<script>
  // @ts-check
  let { code, highlighted, languageName = 'plaintext', langtag = false, ...attributes } = $props();
</script>

<pre class:langtag data-language={languageName} {...attributes}><code class:hljs={true}
