...
<div class="mt-8 code-example">
  <div class="w-full p-4 border border-gray-200 bg-gray-50 rounded-t-xl dark:border-gray-600 dark:bg-gray-700">
    ...
    <span class="inline-flex items-center">Example</span>
    <div class="ml-auto">
  ...
  <div class="relative border-gray-200 border-y border-x code-syntax dark:border-gray-600">
      <div class="grid w-full grid-cols-2 border-b border-gray-200 bg-gray-50 rounded-t-md dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="flex justify-end">
          {#if browserSupport}
          <button on:click={(e) => copyToClipboard(e)} data-tooltip-placement="bottom" type="button" data-copy-state="copy" class="flex items-center px-3 py-2 text-xs font-medium text-gray-600 bg-gray-100 border-l border-gray-200 dark:border-gray-600 dark:text-gray-400 dark:bg-gray-800 hover:text-blue-700 dark:hover:text-white copy-to-clipboard-button">
    ...
    <div class="relative">
      <div class:overflow-hidden={!expand} class:max-h-72={!expand} tabindex="-1">
        <div class="highlight">
