const qtcreatorDark = `<style>pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}.hljs{color:#aaaaaa;background:#000000}.hljs-strong,
