const routeros = `<style>pre code.hljs{display:block;overflow-x:auto;padding:1em}code.hljs{padding:3px 5px}.hljs{color:#444;background:#F0F0F0}.hljs-subst{color:#444}.hljs-comment{color:#888888}.hljs-keyword,
.hljs-selector-tag,
