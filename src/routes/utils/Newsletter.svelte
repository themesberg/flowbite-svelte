...
<aside class="mb-8 flex flex-col items-start justify-center gap-4 rounded-base border bg-white p-4 shadow-lg sm:p-8 dark:border-gray-700 dark:bg-gray-800">
