    ...
    <div class="flex items-center gap-8">
      <div class="flex flex-col justify-start gap-10">
        <div class="flex flex-col gap-4 text-left lg:gap-6">
          <a
            href="https://flowbite-svelte-v2.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
            class="border-primary-200 bg-primary-50 text-primary-700 hover:bg-primary-100 dark:border-primary-800 dark:bg-primary-900/30 dark:text-primary-400 dark:hover:bg-primary-900/50 inline-flex w-fit items-center gap-2 rounded-full border px-4 py-1.5 text-sm font-medium"
          >
            <span class="bg-primary-600 rounded-full px-2 py-0.5 text-xs font-semibold text-white">New</span>
