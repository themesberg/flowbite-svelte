<script lang="ts">
  ...
  let components = $derived([...data.posts.forms, ...data.posts.components, ...data.posts.typography, ...data.posts.extend].sort((a, b) => a.meta.component_title.localeCompare(b.meta.component_title)));
