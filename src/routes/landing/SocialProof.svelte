...
<section
  ...
  <div class="flex flex-col sm:flex-row gap-20">
    <div class="border border-green-300 flex flex-col items-start justify-center gap-3 md:gap-5 w-full">
    ...
    <div class="border border-red-300 flex flex-col items-start gap-6 md:gap-3 w-full">
