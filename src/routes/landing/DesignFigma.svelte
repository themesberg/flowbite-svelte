    ...
    <div class="flex max-w-lg flex-col gap-8">
      ...
      <div class="flex flex-col items-center gap-4">
        ...
        <div class="max-w-l isolate flex flex-col items-start gap-4 self-stretch">
          <Button color="light" class="max-w-lg justify-start! gap-5 self-stretch px-4! sm:gap-7" size="xl" href="https://www.figma.com/file/5pHMkriSz9q98zawojb4mx/flowbite-pro-figma-v2.5.0?node-id=18-0&t=X431WUvSP7jsPiEI-0">
