...
<Section name="testimonial">
	...
	<div class="mb-8 grid lg:mb-12 lg:grid-cols-2">
		<TestimonialCardItem>
			...
			{/snippet}
			<p class="my-4">
				"I recently got my hands on Flowbite Pro, and holy crap, I'm speechless with how easy this was to integrate within my application. Most templates are a pain, code is scattered, and near
				impossible to theme.
			</p>
