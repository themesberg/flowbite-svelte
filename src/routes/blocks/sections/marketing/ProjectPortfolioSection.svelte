<a
  ...
  href="/blocks/marketing/portfolio/"
  ><article
  ...
  >
    <div class="text-left">
      <h2 class="text-base font-medium text-gray-900 dark:text-white">Project Portfolio</h2>
      <p class="text-sm text-gray-500 dark:text-gray-400">0 components</p>
    </div>
    <div class="text-gray-900 dark:text-white">
      <span
        class="text-xs font-medium px-2.5 py-0.5 rounded bg-green-100 text-green-800 dark:bg-green-200 dark:text-green-800"
        >Marketing UI</span
      >
    </div>
  </article>
  <div class="relative flex items-center justify-center h-[calc(100%_-_4rem)]">
    <div class="relative hidden w-full h-auto text-center dark:block">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/marketing/portfolio-dark.svg"
        alt="Project Portfolio thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
    <div class="relative w-full h-auto text-center dark:hidden">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/marketing/portfolio.svg"
        alt="Project Portfolio thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
