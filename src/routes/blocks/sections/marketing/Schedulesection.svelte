<a
  ...
  href="/blocks/marketing/event-schedule/"
  ><article
  ...
  <div class="relative flex items-center justify-center h-[calc(100%_-_4rem)]">
    <div class="relative hidden w-full h-auto text-center dark:block">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/marketing/event-schedule-dark.svg"
        alt="Event Schedule thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
    <div class="relative w-full h-auto text-center dark:hidden">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/marketing/event-schedule.svg"
        alt="Event Schedule thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
