<a
  ...
  href="blocks/application/dashboard-footer/"
  ><article
  ...
  >
    <div class="text-left">
      <h2 class="text-base font-medium text-gray-900 dark:text-white">Dashboard Footers</h2>
  ...
  <div class="relative flex items-center justify-center h-[calc(100%_-_4rem)]">
    <div class="relative hidden w-full h-auto text-center dark:block">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/application/footers-dark.svg"
        alt="Dashboard Footers thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
    <div class="relative w-full h-auto text-center dark:hidden">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/application/footers.svg"
        alt="Dashboard Footers thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
