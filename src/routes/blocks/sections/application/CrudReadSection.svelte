<a
  ...
  href="blocks/application/crud-read-sections/"
  ><article
  ...
  >
    <div class="text-left">
      <h2 class="text-base font-medium text-gray-900 dark:text-white">Read Sections (CRUD)</h2>
  ...
  <div class="relative flex items-center justify-center h-[calc(100%_-_4rem)]">
    <div class="relative hidden w-full h-auto text-center dark:block">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/application/read-page-dark.svg"
        alt="Read Sections (CRUD) thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
    <div class="relative w-full h-auto text-center dark:hidden">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/application/read-page.svg"
        alt="Read Sections (CRUD) thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
