<a
  ...
  href="/blocks/publisher/comments/"
  ><article
  ...
  >
    ...
    <div class="text-gray-900 dark:text-white">
      <span
        class="text-xs font-medium px-2.5 py-0.5 rounded bg-orange-100 text-orange-800 dark:bg-orange-200 dark:text-orange-800"
        >Publisher UI</span
      >
    </div>
  </article>
  <div class="relative flex items-center justify-center h-[calc(100%_-_4rem)]">
    <div class="relative hidden w-full h-auto text-center dark:block">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/publisher/comments-dark.svg"
        alt="Comments Sections thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
    <div class="relative w-full h-auto text-center dark:hidden">
      <img
        src="https://flowbite.s3.amazonaws.com/block-thumbnails/publisher/comments.svg"
        alt="Comments Sections thumbnail dark mode"
        class="max-w-full mx-auto h-44 md:h-52"
      />
    </div>
