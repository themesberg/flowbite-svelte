<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Speed Dial</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-72">
      <span
        ...
        ><img
          alt="Speed Dial"
          src="/images/components/dial.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/dial.svg 640w, /images/components/dial.svg 750w, /images/components/dial.svg 828w, /images/components/dial.svg 1080w, /images/components/dial.svg 1200w, /images/components/dial.svg 1920w, /images/components/dial.svg 2048w, /images/components/dial.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-72">
      <span
        ...
        ><img
          alt="Speed Dial"
          src="/images/components/dial-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-72"
