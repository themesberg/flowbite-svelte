<a
	...
	>
		<span class="text-lg font-medium text-gray-500 dark:text-gray-400">Table</span><span
	...
	<div class="flex justify-center items-center h-52">
		<div class="relative h-4/6 dark:hidden w-48">
			<span
				...
				><img
					alt="Table"
					src="http://flowbite.com/images/components/table.svg"
					decoding="async"
					data-nimg="fill"
					...
					sizes="100vw"
					srcset="http://flowbite.com/images/components/table.svg 640w, http://flowbite.com/images/components/table.svg 750w, http://flowbite.com/images/components/table.svg 828w, http://flowbite.com/images/components/table.svg 1080w, http://flowbite.com/images/components/table.svg 1200w, http://flowbite.com/images/components/table.svg 1920w, http://flowbite.com/images/components/table.svg 2048w, http://flowbite.com/images/components/table.svg 3840w"
				/><noscript /></span
			>
		</div>
