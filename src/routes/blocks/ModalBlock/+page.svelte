  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-48">
      <span
        ...
        ><img
          alt="Modal"
          src="/images/components/modal.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/modal.svg 640w, /images/components/modal.svg 750w, /images/components/modal.svg 828w, /images/components/modal.svg 1080w, /images/components/modal.svg 1200w, /images/components/modal.svg 1920w, /images/components/modal.svg 2048w, /images/components/modal.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-48">
      <span
        ...
        ><img
          alt="Modal"
          src="/images/components/modal-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-48"
