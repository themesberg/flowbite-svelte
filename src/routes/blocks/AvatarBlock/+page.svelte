<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Avatar</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          alt="Avatar"
          src="/images/components/avatar.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/avatar.svg 640w, /images/components/avatar.svg 750w, /images/components/avatar.svg 828w, /images/components/avatar.svg 1080w, /images/components/avatar.svg 1200w, /images/components/avatar.svg 1920w, /images/components/avatar.svg 2048w, /images/components/avatar.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-40">
      <span
        ...
        ><img
          alt="Avatar"
          src="/images/components/avatar-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-40"
