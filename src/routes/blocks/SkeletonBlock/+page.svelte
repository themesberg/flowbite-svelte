<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Skeleton</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          ...
          sizes="100vw"
          srcset="/images/components/skeleton.svg 640w, /images/components/skeleton.svg 750w, /images/components/skeleton.svg 828w, /images/components/skeleton.svg 1080w, /images/components/skeleton.svg 1200w, /images/components/skeleton.svg 1920w, /images/components/skeleton.svg 2048w, /images/components/skeleton.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-40">
      <span
        ...
        ><img
          alt="Skeleton"
          src="/images/components/skeleton-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-40"
