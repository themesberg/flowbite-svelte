...
<Footer footerType="logo" class="bg-white dark:bg-gray-900">
	<div class="max-w-8xl mx-auto flex flex-col py-6 lg:py-12">
		<div class="flex flex-col items-start gap-8 md:justify-between lg:flex-row {isHomePage ? 'px-4 lg:px-20' : ''}">
