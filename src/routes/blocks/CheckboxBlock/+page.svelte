<a
  ...
  ><div
    ...
    <span class="text-base font-medium text-gray-900 dark:text-white">Checkbox</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          alt="Checkbox"
          src="/images/components/checkbox.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/checkbox.svg 640w, /images/components/checkbox.svg 750w, /images/components/checkbox.svg 828w, /images/components/checkbox.svg 1080w, /images/components/checkbox.svg 1200w, /images/components/checkbox.svg 1920w, /images/components/checkbox.svg 2048w, /images/components/checkbox.svg 3840w" /><noscript /></span>
    </div>
