  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-56">
      <span
        ...
        ><img
          alt="Range Slider"
          src="/images/components/range-slider.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/range-slider.svg 640w, /images/components/range-slider.svg 750w, /images/components/range-slider.svg 828w, /images/components/range-slider.svg 1080w, /images/components/range-slider.svg 1200w, /images/components/range-slider.svg 1920w, /images/components/range-slider.svg 2048w, /images/components/range-slider.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-56">
      <span
        ...
        ><img
          alt="Range Slider"
          src="/images/components/range-slider-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-56"
