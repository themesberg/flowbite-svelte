<a
  href="/components/floating-label/"
  {...$$restProps}
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          alt="Floating Label"
          src="/images/components/floating-label.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/floating-label.svg 640w, /images/components/floating-label.svg 750w, /images/components/floating-label.svg 828w, /images/components/floating-label.svg 1080w, /images/components/floating-label.svg 1200w, /images/components/floating-label.svg 1920w, /images/components/floating-label.svg 2048w, /images/components/floating-label.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-40">
      <span
        ...
        ><img
          alt="Floating Label"
          src="/images/components/floating-label-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-40"
