<a
  ...
  ><div
    ...
    <span class="text-base font-medium text-gray-900 dark:text-white">Gallery (Masonry)</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-64">
      <span
        ...
        ><img
          alt="Gallery (Masonry)"
          src="/images/components/gallery.svg"
          decoding="async"
          data-nimg="fill"
    ...
    <div class="hidden relative h-4/6 dark:block w-64">
      <span
        ...
        ><img
          alt="Gallery (Masonry)"
          src="/images/components/gallery-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-64"
          ...
          sizes="100vw"
          srcset="/images/components/gallery-dark.svg 640w, /images/components/gallery-dark.svg 750w, /images/components/gallery-dark.svg 828w, /images/components/gallery-dark.svg 1080w, /images/components/gallery-dark.svg 1200w, /images/components/gallery-dark.svg 1920w, /images/components/gallery-dark.svg 2048w, /images/components/gallery-dark.svg 3840w" /><noscript /></span>
    </div>
  </div></a>
