<a
  href="/docs/experimental/datepicker"
  rel="external"
  {...$$restProps}
  ...
  ><div
    ...
    <span class="text-base font-medium text-gray-900 dark:text-white">Datepicker</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-28">
      <span
        ...
        ><img
          alt="Datepicker"
          src="/images/components/datepicker.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/datepicker.svg 640w, /images/components/datepicker.svg 750w, /images/components/datepicker.svg 828w, /images/components/datepicker.svg 1080w, /images/components/datepicker.svg 1200w, /images/components/datepicker.svg 1920w, /images/components/datepicker.svg 2048w, /images/components/datepicker.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-28">
      <span
        ...
        ><img
          alt="Datepicker"
          src="/images/components/dropdown-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-28"
