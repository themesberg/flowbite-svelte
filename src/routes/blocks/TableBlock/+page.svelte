  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-48">
      <span
        ...
        ><img
          alt="Table"
          src="/images/components/table.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/table.svg 640w, /images/components/table.svg 750w, /images/components/table.svg 828w, /images/components/table.svg 1080w, /images/components/table.svg 1200w, /images/components/table.svg 1920w, /images/components/table.svg 2048w, /images/components/table.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-48">
      <span
        ...
        ><img
          alt="Table"
          src="/images/components/table-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-48"
