  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-48">
      <span
        ...
        ><img
          alt="Carousel"
          src="/images/components/carousel.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/carousel.svg 640w, /images/components/carousel.svg 750w, /images/components/carousel.svg 828w, /images/components/carousel.svg 1080w, /images/components/carousel.svg 1200w, /images/components/carousel.svg 1920w, /images/components/carousel.svg 2048w, /images/components/carousel.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-48">
      <span
        ...
        ><img
          alt="Carousel"
          src="/images/components/carousel-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-48"
