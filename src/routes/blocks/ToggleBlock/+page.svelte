  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          alt="Toggle"
          src="/images/components/toggle.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/toggle.svg 640w, /images/components/toggle.svg 750w, /images/components/toggle.svg 828w, /images/components/toggle.svg 1080w, /images/components/toggle.svg 1200w, /images/components/toggle.svg 1920w, /images/components/toggle.svg 2048w, /images/components/toggle.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-40">
      <span
        ...
        ><img
          alt="Toggle"
          src="/images/components/toggle-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-40"
