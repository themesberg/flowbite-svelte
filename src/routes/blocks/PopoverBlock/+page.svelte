<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Popover</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-56">
      <span
        ...
        ><img
          alt="Popover"
          src="/images/components/popover.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/popover.svg 640w, /images/components/popover.svg 750w, /images/components/popover.svg 828w, /images/components/popover.svg 1080w, /images/components/popover.svg 1200w, /images/components/popover.svg 1920w, /images/components/popover.svg 2048w, /images/components/popover.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-56">
      <span
        ...
        ><img
          alt="Popover"
          src="/images/components/popover-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-56"
