<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Cards</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-36">
      <span
        ...
        ><img
          alt="Cards"
          src="/images/components/cards.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/cards.svg 640w, /images/components/cards.svg 750w, /images/components/cards.svg 828w, /images/components/cards.svg 1080w, /images/components/cards.svg 1200w, /images/components/cards.svg 1920w, /images/components/cards.svg 2048w, /images/components/cards.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-36">
      <span
        ...
        ><img
          alt="Cards"
          src="/images/components/cards-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-36"
