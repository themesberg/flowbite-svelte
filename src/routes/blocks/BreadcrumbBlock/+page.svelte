<a
  ...
  ><div
    ...
    <span class="text-base font-medium text-gray-900 dark:text-white">Breadcrumb</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-64">
      <span
        ...
        ><img
          alt="Breadcrumbs"
          src="/images/components/breadcrumbs.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/breadcrumbs.svg 640w, /images/components/breadcrumbs.svg 750w, /images/components/breadcrumbs.svg 828w, /images/components/breadcrumbs.svg 1080w, /images/components/breadcrumbs.svg 1200w, /images/components/breadcrumbs.svg 1920w, /images/components/breadcrumbs.svg 2048w, /images/components/breadcrumbs.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-64">
      <span
        ...
        ><img
          alt="Breadcrumbs"
          src="/images/components/breadcrumbs-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-64"
