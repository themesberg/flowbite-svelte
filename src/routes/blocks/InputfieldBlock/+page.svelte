  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          alt="Input Field"
          src="/images/components/input-field.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/input-field.svg 640w, /images/components/input-field.svg 750w, /images/components/input-field.svg 828w, /images/components/input-field.svg 1080w, /images/components/input-field.svg 1200w, /images/components/input-field.svg 1920w, /images/components/input-field.svg 2048w, /images/components/input-field.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-40">
      <span
        ...
        ><img
          alt="Input Field"
          src="/images/components/input-field-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-40"
