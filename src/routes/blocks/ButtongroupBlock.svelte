<a
	...
	>
		<span class="text-lg font-medium text-gray-500 dark:text-gray-400">Button group</span><span
	...
	<div class="flex justify-center items-center h-52">
		<div class="relative h-4/6 dark:hidden w-56">
			<span
				...
				><img
					alt="Button group"
					src="http://flowbite.com/images/components/button-group.svg"
					decoding="async"
					data-nimg="fill"
					...
					sizes="100vw"
					srcset="http://flowbite.com/images/components/button-group.svg 640w, http://flowbite.com/images/components/button-group.svg 750w, http://flowbite.com/images/components/button-group.svg 828w, http://flowbite.com/images/components/button-group.svg 1080w, http://flowbite.com/images/components/button-group.svg 1200w, http://flowbite.com/images/components/button-group.svg 1920w, http://flowbite.com/images/components/button-group.svg 2048w, http://flowbite.com/images/components/button-group.svg 3840w"
				/><noscript /></span
			>
		</div>
