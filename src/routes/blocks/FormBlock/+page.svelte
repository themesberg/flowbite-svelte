  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          alt="Forms"
          src="/images/components/forms.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/forms.svg 640w, /images/components/forms.svg 750w, /images/components/forms.svg 828w, /images/components/forms.svg 1080w, /images/components/forms.svg 1200w, /images/components/forms.svg 1920w, /images/components/forms.svg 2048w, /images/components/forms.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-40">
      <span
        ...
        ><img
          alt="Forms"
          src="/images/components/forms-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-40"
