  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-56">
      <span
        ...
        ><img
          alt="Footer"
          src="/images/components/footer.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/footer.svg 640w, /images/components/footer.svg 750w, /images/components/footer.svg 828w, /images/components/footer.svg 1080w, /images/components/footer.svg 1200w, /images/components/footer.svg 1920w, /images/components/footer.svg 2048w, /images/components/footer.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-56">
      <span
        ...
        ><img
          alt="Footer"
          src="/images/components/footer-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-56"
