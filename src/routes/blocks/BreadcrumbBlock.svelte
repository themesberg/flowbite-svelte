	...
	<div class="flex justify-center items-center h-52">
		<div class="relative h-4/6 dark:hidden w-64">
			<span
				...
				><img
					alt="Breadcrumbs"
					src="http://flowbite.com/images/components/breadcrumbs.svg"
					decoding="async"
					data-nimg="fill"
					...
					sizes="100vw"
					srcset="http://flowbite.com/images/components/breadcrumbs.svg 640w, http://flowbite.com/images/components/breadcrumbs.svg 750w, http://flowbite.com/images/components/breadcrumbs.svg 828w, http://flowbite.com/images/components/breadcrumbs.svg 1080w, http://flowbite.com/images/components/breadcrumbs.svg 1200w, http://flowbite.com/images/components/breadcrumbs.svg 1920w, http://flowbite.com/images/components/breadcrumbs.svg 2048w, http://flowbite.com/images/components/breadcrumbs.svg 3840w"
				/><noscript /></span
			>
		</div>
