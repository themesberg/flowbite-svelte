<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Heading</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-72">
      <span
        ...
        ><img
          alt="Heading"
          src="/images/components/heading.svg"
          decoding="async"
          data-nimg="fill"
    ...
    <div class="hidden relative h-4/6 dark:block w-72">
      <span
        ...
        ><img
          alt="Heading"
          src="/images/components/heading-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-72"
          ...
          sizes="100vw"
          srcset="/images/components/heading-dark.svg 640w, /images/components/heading-dark.svg 750w, /images/components/heading-dark.svg 828w, /images/components/heading-dark.svg 1080w, /images/components/heading-dark.svg 1200w, /images/components/heading-dark.svg 1920w, /images/components/heading-dark.svg 2048w, /images/components/heading-dark.svg 3840w" /><noscript /></span>
    </div>
  </div></a>
