  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-28">
      <span
        ...
        ><img
          alt="Dropdown"
          src="/images/components/dropdown.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/dropdown.svg 640w, /images/components/dropdown.svg 750w, /images/components/dropdown.svg 828w, /images/components/dropdown.svg 1080w, /images/components/dropdown.svg 1200w, /images/components/dropdown.svg 1920w, /images/components/dropdown.svg 2048w, /images/components/dropdown.svg 3840w" /><noscript /></span>
    </div>
