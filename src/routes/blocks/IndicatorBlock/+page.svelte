<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Indicators</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-64">
      <span
        ...
        ><img
          alt="Indicators"
          src="/images/components/indicators.svg"
          decoding="async"
          data-nimg="fill"
    ...
    <div class="hidden relative h-4/6 dark:block w-64">
      <span
        ...
        ><img
          alt="Indicators"
          src="/images/components/indicators-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-64"
          ...
          sizes="100vw"
          srcset="/images/components/indicators-dark.svg 640w, /images/components/indicators-dark.svg 750w, /images/components/indicators-dark.svg 828w, /images/components/indicators-dark.svg 1080w, /images/components/indicators-dark.svg 1200w, /images/components/indicators-dark.svg 1920w, /images/components/indicators-dark.svg 2048w, /images/components/indicators-dark.svg 3840w" /><noscript /></span>
    </div>
  </div></a>
