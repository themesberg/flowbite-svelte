  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-56">
      <span
        ...
        ><img
          alt="Button group"
          src="/images/components/button-group.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/button-group.svg 640w, /images/components/button-group.svg 750w, /images/components/button-group.svg 828w, /images/components/button-group.svg 1080w, /images/components/button-group.svg 1200w, /images/components/button-group.svg 1920w, /images/components/button-group.svg 2048w, /images/components/button-group.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-56">
      <span
        ...
        ><img
          alt="Button group"
          src="/images/components/button-group-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-56"
