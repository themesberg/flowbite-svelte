<a
  ...
  ><div
    ...
    <span class="text-base font-medium text-gray-900 dark:text-white">Bottom Navigation</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-64">
      <span
        ...
        ><img
          ...
          src="/images/components/bottom-bar.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/bottom-bar.svg 640w, /images/components/bottom-bar.svg 750w, /images/components/bottom-bar.svg 828w, /images/components/bottom-bar.svg 1080w, /images/components/bottom-bar.svg 1200w, /images/components/bottom-bar.svg 1920w, /images/components/bottom-bar.svg 2048w, /images/components/bottom-bar.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-64">
      <span
        ...
        ><img
          alt="Bottom Navigation"
          src="/images/components/bottom-bar-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-64"
