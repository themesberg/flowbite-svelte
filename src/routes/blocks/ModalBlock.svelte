<a
	...
	>
		<span class="text-lg font-medium text-gray-500 dark:text-gray-400">Modal</span><span
	...
	<div class="flex justify-center items-center h-52">
		<div class="relative h-4/6 dark:hidden w-48">
			<span
				...
				><img
					alt="Modal"
					src="http://flowbite.com/images/components/modal.svg"
					decoding="async"
					data-nimg="fill"
					...
					sizes="100vw"
					srcset="http://flowbite.com/images/components/modal.svg 640w, http://flowbite.com/images/components/modal.svg 750w, http://flowbite.com/images/components/modal.svg 828w, http://flowbite.com/images/components/modal.svg 1080w, http://flowbite.com/images/components/modal.svg 1200w, http://flowbite.com/images/components/modal.svg 1920w, http://flowbite.com/images/components/modal.svg 2048w, http://flowbite.com/images/components/modal.svg 3840w"
				/><noscript /></span
			>
		</div>
