  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-36">
      <span
        ...
        ><img
          alt="List group"
          src="/images/components/list-group.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/list-group.svg 640w, /images/components/list-group.svg 750w, /images/components/list-group.svg 828w, /images/components/list-group.svg 1080w, /images/components/list-group.svg 1200w, /images/components/list-group.svg 1920w, /images/components/list-group.svg 2048w, /images/components/list-group.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-36">
      <span
        ...
        ><img
          alt="List group"
          src="/images/components/list-group-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-36"
