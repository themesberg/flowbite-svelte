  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-48">
      <span
        ...
        ><img
          alt="Rating"
          src="/images/components/rating.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/rating.svg 640w, /images/components/rating.svg 750w, /images/components/rating.svg 828w, /images/components/rating.svg 1080w, /images/components/rating.svg 1200w, /images/components/rating.svg 1920w, /images/components/rating.svg 2048w, /images/components/rating.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-48">
      <span
        ...
        ><img
          alt="Rating"
          src="/images/components/rating-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-48"
