  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-32">
      <span
        ...
        ><img
          ...
          sizes="100vw"
          srcset="/images/components/spinner.svg 640w, /images/components/spinner.svg 750w, /images/components/spinner.svg 828w, /images/components/spinner.svg 1080w, /images/components/spinner.svg 1200w, /images/components/spinner.svg 1920w, /images/components/spinner.svg 2048w, /images/components/spinner.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-32">
      <span
        ...
        ><img
          alt="Spinner"
          src="/images/components/spinner-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-32"
