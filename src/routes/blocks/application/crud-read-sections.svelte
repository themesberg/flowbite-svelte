...
<SectionBlock title="Default read section">
  Use this free example of a "read" CRUD layout section to show details of an existing data entry
  from your database.
</SectionBlock>
...
<ExampleDiv>
  <Section name="crudreadsection">
    <Heading
      ...
      class="mb-2">Apple iMac 25"</Heading
    >
