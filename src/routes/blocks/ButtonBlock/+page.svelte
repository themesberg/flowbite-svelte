  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-24">
      <span
        ...
        ><img
          alt="Buttons"
          src="/images/components/buttons.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/buttons.svg 640w, /images/components/buttons.svg 750w, /images/components/buttons.svg 828w, /images/components/buttons.svg 1080w, /images/components/buttons.svg 1200w, /images/components/buttons.svg 1920w, /images/components/buttons.svg 2048w, /images/components/buttons.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-24">
      <span
        ...
        ><img
          alt="Buttons"
          src="/images/components/buttons-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-24"
