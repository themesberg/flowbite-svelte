<a
	...
	>
		<span class="text-lg font-medium text-gray-500 dark:text-gray-400">Select</span><span
	...
	<div class="flex justify-center items-center h-52">
		<div class="relative h-4/6 dark:hidden w-56">
			<span
				...
				><img
					alt="Select"
					src="http://flowbite.com/images/components/select.svg"
					decoding="async"
					data-nimg="fill"
					...
					sizes="100vw"
					srcset="http://flowbite.com/images/components/select.svg 640w, http://flowbite.com/images/components/select.svg 750w, http://flowbite.com/images/components/select.svg 828w, http://flowbite.com/images/components/select.svg 1080w, http://flowbite.com/images/components/select.svg 1200w, http://flowbite.com/images/components/select.svg 1920w, http://flowbite.com/images/components/select.svg 2048w, http://flowbite.com/images/components/select.svg 3840w"
				/><noscript /></span
			>
		</div>
