		...
		<div class="relative h-4/6 dark:hidden w-56">
			<span
				...
				><img
					...
					sizes="100vw"
					srcset="/images/components/select.svg 640w, /images/components/select.svg 750w, /images/components/select.svg 828w, /images/components/select.svg 1080w, /images/components/select.svg 1200w, /images/components/select.svg 1920w, /images/components/select.svg 2048w, /images/components/select.svg 3840w"
				/><noscript /></span
			>
		</div>
