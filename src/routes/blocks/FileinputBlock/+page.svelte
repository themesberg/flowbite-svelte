<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">File Input</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-48">
      <span
        ...
        ><img
          ...
          sizes="100vw"
          srcset="/images/components/file-input.svg 640w, /images/components/file-input.svg 750w, /images/components/file-input.svg 828w, /images/components/file-input.svg 1080w, /images/components/file-input.svg 1200w, /images/components/file-input.svg 1920w, /images/components/file-input.svg 2048w, /images/components/file-input.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-48">
      <span
        ...
        ><img
          alt="File Input"
          src="/images/components/file-input-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-48"
