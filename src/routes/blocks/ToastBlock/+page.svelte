  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-48">
      <span
        ...
        ><img
          alt="Toast"
          src="/images/components/toast.svg"
          decoding="async"
          data-nimg="fill"
          ...
          sizes="100vw"
          srcset="/images/components/toast.svg 640w, /images/components/toast.svg 750w, /images/components/toast.svg 828w, /images/components/toast.svg 1080w, /images/components/toast.svg 1200w, /images/components/toast.svg 1920w, /images/components/toast.svg 2048w, /images/components/toast.svg 3840w" /><noscript /></span>
    </div>
    <div class="hidden relative h-4/6 dark:block w-48">
      <span
        ...
        ><img
          alt="Toast"
          src="/images/components/toast-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-48"
