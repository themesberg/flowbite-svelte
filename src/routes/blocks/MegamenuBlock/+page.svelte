<a
  ...
  ><div
    ...
    <span class="text-lg font-medium text-gray-500 dark:text-gray-400">Mega menu</span><span
  ...
  <div class="flex justify-center items-center h-52">
    <div class="relative h-4/6 dark:hidden w-40">
      <span
        ...
        ><img
          alt="Mega menu"
          src="/images/components/mega-menu.svg"
          decoding="async"
          data-nimg="fill"
    ...
    <div class="hidden relative h-4/6 dark:block w-40">
      <span
        ...
        ><img
          alt="Mega menu"
          src="/images/components/mega-menu-dark.svg"
          decoding="async"
          data-nimg="fill"
          class="w-40"
