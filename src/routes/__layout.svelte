<script>
  ...
  let topli =
    "block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50  md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-300 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white  dark:border-gray-700 text-lg z-50 bg-white dark:bg-gray-700";
  let topul =
