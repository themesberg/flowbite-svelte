...
<CodeWrapper>
  <DeviceMockup device="tablet">
    <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/tablet-mockup-image.png" class="h-[426px] dark:hidden md:h-[654px]" alt="tablet example 1" />
    <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/tablet-mockup-image-dark.png" class="hidden h-[426px] dark:block md:h-[654px]" alt="tablet example 2" />
  </DeviceMockup>
</CodeWrapper>
...
<CodeWrapper>
  <DeviceMockup device="laptop">
    <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/laptop-screen.png" class="h-[156px] w-full rounded-xl dark:hidden md:h-[278px]" alt="laptop example 1" />
    <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/laptop-screen-dark.png" class="hidden h-[156px] w-full rounded-lg dark:block md:h-[278px]" alt="laptop example 2" />
  </DeviceMockup>
</CodeWrapper>
...
<CodeWrapper>
  <DeviceMockup device="desktop">
    <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/screen-image-imac.png" class="h-[140px] w-full rounded-xl dark:hidden md:h-[262px]" alt="desktop example 1" />
    <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/screen-image-imac-dark.png" class="hidden h-[140px] w-full rounded-xl dark:block md:h-[262px]" alt="desktop example 2" />
  </DeviceMockup>
</CodeWrapper>
