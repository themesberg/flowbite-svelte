...
<CodeWrapper>
  ...
  {#snippet codeblock()}
    <HighlightCompo codeLang="ts" code={exampleModules["./examples/HeadBodyItems.svelte"] as string} />
  {/snippet}
</CodeWrapper>
...
<CodeWrapper>
  ...
  {#snippet codeblock()}
    <HighlightCompo codeLang="ts" code={exampleModules["./examples/TableCaption.svelte"] as string} />
  {/snippet}
</CodeWrapper>
