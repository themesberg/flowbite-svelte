...
<div class="relative flex flex-col p-6">
  ...
  <BottomNav position="absolute" navType="application" innerClass="grid-cols-5">
    <BottomNavItem btnName="Home" appBtnPosition="left" btnClass='static'>
      <HomeSolid id="home" class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500" />
    </BottomNavItem>
    <BottomNavItem btnName="Wallet" appBtnPosition="middle">
      <WalletSolid id='wallet' class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500" />
    </BottomNavItem>
    ...
    <BottomNavItem btnName="Settings" appBtnPosition="middle">
      <AdjustmentsVerticalOutline id="settings" class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500" />
    </BottomNavItem>
    <BottomNavItem btnName="Profile" appBtnPosition="right">
      <UserCircleSolid id="profile" class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-primary-600 dark:group-hover:text-primary-500" />
    </BottomNavItem>
  </BottomNav>
</div>