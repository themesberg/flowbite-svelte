...
<HighlightCompo
  codeLang="ts"
  code={modules['./md/links-and-active-class.md'] as string}
/>
...
<HighlightCompo
  codeLang="ts"
  code={modules['./md/overwriting-activeclass.md'] as string}
/>
...
<CodeWrapper class="relative flex flex-col">
  ...
  <BottomNav position="absolute" innerClass="grid-cols-4">
    ...
    <BottomNavItem btnName="Quickstart" href="/docs/pages/quickstart">
      <WalletSolid
        class={activeUrl === '/docs/pages/quickstart'
          ? svgActiveClass
          : svgClass}
      />
    </BottomNavItem>
    ...
    >
      <AdjustmentsVerticalSolid
        class={activeUrl === '/docs/components/bottom-navigation'
          ? svgActiveClass
          : svgClass}
      />
    </BottomNavItem>
    <BottomNavItem btnName="Accordion" href="/docs/components/accordion">
      <UserCircleSolid
        class={activeUrl === '/docs/components/accordion'
          ? svgActiveClass
          : svgClass}
      />
    </BottomNavItem>
