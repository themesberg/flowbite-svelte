<script lang="ts">
  ...
  const exampleArr = [
    ...
    { name: 'Logo', component: ExampleComponents.Logo },
    { name: 'Sitemap link', component: ExampleComponents.SitemapLink },
    { name: 'Social media', component: ExampleComponents.SocialMedia },
