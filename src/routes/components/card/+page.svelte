...
<p>
  To create a linkable card, use the <code>href</code> prop. However, avoid including
  an additional link inside the card itself, since you are adding a-tag within a-tag.
</p>
