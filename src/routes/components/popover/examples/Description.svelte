...
<div class="h-80">
  ...
  <Popover arrow={false} trigger="hover" triggeredBy="#b3" class="w-72 bg-white p-3 text-sm font-light text-gray-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400" placement="bottom-start">
    <div class="space-y-2 p-3">
      ...
      <a href="/" class="text-primary-600 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-600 flex items-center font-medium">
