			...
			<p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
				...
				<span>
					New brand identity has been launched for the <a
						...
						class="text-primary-600 dark:text-primary-500 inline font-medium underline decoration-solid decoration-600 underline-offset-2 hover:no-underline dark:decoration-500"
						>Flowbite Library</a
					>
				</span>
			</p>
