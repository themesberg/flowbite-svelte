...
<CodeWrapper>
  <div id="placements" class="my-8 flex h-[420px] flex-col items-center justify-center gap-2">
...
<H2>Active link</H2>
<CodeWrapper innerClass="flex h-64 items-start justify-center">
...
<CodeWrapper innerClass="flex h-96 items-start justify-center">
...
<H2>Helper text</H2>
<CodeWrapper innerClass="relative flex h-96 items-start justify-center">
...
<CodeWrapper innerClass="relative flex h-96 items-start justify-center">
  ...
  <div class="relative">
    <Dropdown dropdownStatus={dropdownToggleStatus} closeDropdown={closeDropdownToggle} params={transitionParams} class="absolute -left-[185px] top-[45px] w-48 overflow-y-auto text-sm">
...
<CodeWrapper innerClass="flex h-72 items-start justify-center">
...
<H2>Menu icon</H2>
<CodeWrapper innerClass="flex h-56 items-start justify-center">
...
<CodeWrapper innerClass="flex h-[430px] items-start justify-center">
