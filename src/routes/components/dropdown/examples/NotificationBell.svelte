...
<div class="flex h-[360px] items-start justify-center">
  ...
  <div class="relative">
    <Dropdown dropdownStatus={dropdownNotificationStatus} closeDropdown={closeDropdownNotification} params={{ y: 0, duration: 200, easing: sineIn }} class="absolute top-[30px] -left-[230px] w-96">
