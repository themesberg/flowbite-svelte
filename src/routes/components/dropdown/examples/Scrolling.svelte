<script lang="ts">
  import { Avatar, Button, Dropdown, DropdownFooter, DropdownLi, DropdownUl, uiHelpers } from "$lib";
  import { ChevronDownOutline } from "flowbite-svelte-icons";
</script>

<div class="flex h-60 items-start justify-center">
  <Button>Dropdown <ChevronDownOutline class="ms-2 h-5 w-5 text-white dark:text-white" /></Button>
  <Dropdown class=" w-48">
    <DropdownUl class="h-40 w-52 overflow-y-scroll py-2">
