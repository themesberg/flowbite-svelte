...
<div class="container flex flex-wrap mt-8 mx-auto justify-center">
  <h1 class="text-3xl dark:text-white w-full py-4 text-center">Modal Components</h1>
  <div class="p-4">
  ...
  <div class="p-4">
    <Card img="/images/modals.webp" btnColor="pink" header="Extra-large Modals" link="/modals/extra-large" />
  </div>
  <div class="p-4">
    <Card img="/images/modals.webp" btnColor="indigo" header="Signin Modals" link="/modals/signin" />
  </div>
</div>
