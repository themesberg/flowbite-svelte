...
<CodeWrapper>
  <P color="text-gray-500 dark:text-gray-400"
    ...
    running a usability test, you’ll be able to see how users will interact with your design once it’s live.</P
  >
  ...
  <P color="text-gray-500 dark:text-gray-400"
    ...
    Tailwind CSS that you can just copy-paste from the documentation.</P
  >
</CodeWrapper>
...
<CodeWrapper>
  <Blockquote size="xl">
    ...
    "Flowbite is just awesome. It contains tons of predesigned components and pages starting from login screen to complex dashboard. Perfect choice for
...
<CodeWrapper>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 md:gap-6">
    ...
    <Blockquote class="mb-3" size="xl"
      ...
      choice for your next SaaS application. "</Blockquote
    >
  </div>
  <P pclass="mb-3" color="text-gray-500 dark:text-gray-400"
