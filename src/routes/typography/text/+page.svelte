...
<CodeWrapper>
  <P>
    ...
    <Span italic={spanItalic} underline={spanUnderline} class="text-red-500"
      >Link issues across Jira</Span
    > and ingest data from other <Span
      linethrough={spanLinethrough}
      uppercase={spanUppercase}
      class="text-blue-500">software development</Span
  ...
  <div class="mt-4 flex flex-wrap items-center gap-2 rtl:space-x-reverse">
    ...
    <Button onclick={() => (spanLinethrough = !spanLinethrough)}
      >Linethrough</Button
    >
  ...
  <div class="mt-4 flex flex-wrap space-x-4">
    ...
    {#each highlights as highlight}
      <Radio
        ...
        value={highlight}>{highlight}</Radio
      >
    {/each}
  </div>
</CodeWrapper>
  ...
  <div class="mt-8 flex flex-wrap space-x-4">
    ...
    {#each decorations as decoration}
      <Radio
        ...
        value={decoration}>{decoration}</Radio
      >
    {/each}
  </div>
  <div class="mt-4 flex flex-wrap space-x-4">
  ...
  <div class="mt-4 flex flex-wrap space-x-4">
    ...
    {#each docrationThickness as thickness}
      <Radio
        ...
        value={thickness}>{thickness}</Radio
      >
    {/each}
  </div>
</CodeWrapper>
...
<CodeWrapper>
  <P size="xl"
    ><Span class="text-blue-600 dark:text-blue-500">
      Flowbite app will help you</Span
    > improve yourself by analysing your everyday life.</P
  >
  <P size="xl"
    ><Span class="text-blue-600/75 dark:text-blue-500/75"
      >Flowbite app will help you</Span
    > improve yourself by analysing your everyday life.</P
  >
  <P size="xl"
    ><Span class="text-blue-600/50 dark:text-blue-500/50"
      >Flowbite app will help you</Span
    > improve yourself by analysing your everyday life.</P
  >
  <P size="xl"
    ><Span class="text-blue-600/25 dark:text-blue-500/25"
      >Flowbite app will help you</Span
    > improve yourself by analysing your everyday life.</P
  >
</CodeWrapper>
