<script>
  import { Htwo, ExampleDiv, CompoDescription, TableProp, TableDefaultRow, PageHeadSection } from '../utils';
  ...
  const title = 'Svelte Datepicker - Flowbite';
  const description =
  ...
  const libFiles = {};
  const breadcrumb_title = 'Svelte Datepicker';
  const dir = 'Experimental';
</script>
