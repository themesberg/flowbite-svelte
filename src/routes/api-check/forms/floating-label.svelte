...
<div id="exampleWrapper" class="my-4 grid w-full items-end gap-6 rounded border border-gray-200 p-8 md:grid-cols-3 dark:border-gray-600">
...
<div id="exampleWrapper" class="items-endrounded my-4 w-full rounded border border-gray-200 p-8 dark:border-gray-600">
  <FloatingLabelInput
    clearable
    clearableOnClick={() => {
...
<!-- Success messages -->
<div class="my-4 mb-6 grid items-end gap-6 rounded border border-gray-200 p-8 md:grid-cols-3 dark:border-gray-600">
  <div>
