...
<H2>Glow</H2>
<CodeWrapper>
  <ExampleComponents.Glow />
  {#snippet codeblock()}
    <HighlightCompo codeLang="ts" code={exampleModules["./examples/Glow.svelte"] as string} />
  {/snippet}
</CodeWrapper>

<H2>HideLabel</H2>
<CodeWrapper>
  <ExampleComponents.HideLabel />
  {#snippet codeblock()}
    <HighlightCompo codeLang="ts" code={exampleModules["./examples/HideLabel.svelte"] as string} />
  {/snippet}
</CodeWrapper>
