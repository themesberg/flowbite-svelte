...
<H2>Multiple mode 2</H2>
<CodeWrapper innerClass="space-y-4">
  <ExampleComponents.MultipleMode2 />
  {#snippet codeblock()}
    <HighlightCompo codeLang="ts" code={exampleModules["./examples/MultipleMode2.svelte"] as string} />
  {/snippet}
</CodeWrapper>
...
<H2>Transtion None</H2>
<CodeWrapper innerClass="space-y-4">
  <ExampleComponents.TransitionNone />
  {#snippet codeblock()}
