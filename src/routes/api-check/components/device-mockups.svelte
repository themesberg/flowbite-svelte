...
<h1 class="my-4 text-3xl">Device Mockups</h1>

<h2 class="my-4 text-2xl">Default mockup</h2>
...
<h2 class="my-4 text-2xl">iPhone 12 mockup (iOS)</h2>
<div class="border rounded p-4 my-4">
...
<h2 class="my-4 text-2xl">Google Pixel mockup (Android)</h2>
<div class="border rounded p-4 my-4">
...
<h2 class="my-4 text-2xl">Tablet mockup</h2>
<div class="border rounded p-4 my-4">
...
<h2 class="my-4 text-2xl">Laptop mockup</h2>
  <div class="border rounded p-4 my-4">
  ...
  <h2 class="my-4 text-2xl">Desktop mockup</h2>
  <div class="border rounded p-4 my-4">
...
<h2 class="my-4 text-2xl">Smartwatch mockup</h2>
<div class="border rounded p-4 my-4">
