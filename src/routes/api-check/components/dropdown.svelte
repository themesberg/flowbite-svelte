...
<div class="my-4 flex h-64 items-start justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-80 items-start justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
  <Button>Dropdown button<ChevronDownOutline class="ms-2 h-6 w-6 text-white dark:text-white" /></Button>
  <Dropdown>
    <DropdownHeader>
...
<div class="my-4 flex h-64 flex-col items-center justify-center gap-4 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-52 items-start justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-56 items-start justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
  <Button>Dropdown checkbox<ChevronDownOutline class="ms-2 h-6 w-6 text-white dark:text-white" /></Button>
...
<div class="my-4 flex h-60 items-start justify-center gap-4 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-80 items-start justify-center gap-4 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="rounded border border-gray-200 p-4 dark:border-gray-600">
