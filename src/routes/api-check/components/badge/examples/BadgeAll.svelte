...
<div class="flex flex-wrap gap-2 rounded border border-gray-200 p-4 dark:border-gray-600">
  <Badge>Default</Badge>
...
<div class="flex flex-wrap gap-4 rounded border p-4">
...
<div class="my-4 flex flex-wrap gap-4 rounded border p-4">
  <Badge dismissable>
    Default
    {#snippet icon()}
