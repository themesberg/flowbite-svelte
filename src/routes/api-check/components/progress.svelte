...
<div class="my-4 rounded border border-gray-200 p-4 dark:border-gray-600">
  <Progressbar progress="50" size="h-3" labelInside color="green" labelOutside="Size h-3" classes={{
  labelInsideDiv:"text-xs font-medium text-center p-0 leading-none rounded-full", base:"my-4" }}/>
