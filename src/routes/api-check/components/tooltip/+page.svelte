...
<div class="my-4 flex h-32 items-end justify-center rounded border border-gray-200 p-8 dark:border-gray-600">
...
<div class="my-4 flex h-32 items-end justify-center space-x-4 rounded border border-gray-200 p-8 dark:border-gray-600">
...
<div class="my-4 flex h-72 flex-col items-center justify-center gap-4 rounded border border-gray-200 dark:border-gray-600">
