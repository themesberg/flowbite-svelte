...
<div class="my-4 flex h-44 items-end justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-74 items-end justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-100 items-end justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-96 items-end rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 h-96 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-60 items-end justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
  <Button>
...
<div class="my-4 flex h-96 flex-col items-center justify-center gap-4 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-44 items-end justify-center gap-4 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-56 items-end justify-center rounded border border-gray-200 p-4 dark:border-gray-600">
  <Button>Default popover</Button>
...
<div class="my-4 flex h-72 flex-col items-center justify-center gap-4 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 flex h-44 flex-col items-center justify-center space-y-4 rounded border border-gray-200 p-4 dark:border-gray-600">
