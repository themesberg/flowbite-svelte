...
<div class="relative my-4 h-96 rounded border border-gray-200 p-4 dark:border-gray-600">
...
<div class="my-4 grid w-fit grid-cols-8 gap-x-6 gap-y-18 rounded border border-gray-200 p-4 py-16 dark:border-gray-600">
...
<div class="relative my-4 h-[400px] rounded border border-gray-200 p-4 dark:border-gray-600">
