...
<div class="border rounded p-4 my-4 relative h-96">
...
<div class="border rounded p-4 py-16 my-4 grid w-fit grid-cols-8 gap-x-6 gap-y-18">
...
<div class="border rounded p-4 my-4 relative h-[400px]">
