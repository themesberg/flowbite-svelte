...
<h2 class="text-2xl w-full mt-8 dark:text-white py-8">Simple Card</h2>
...
<h2 class="text-2xl w-full mt-8 dark:text-white py-8">Card with Link</h2>
...
<h2 class="text-2xl w-full mt-8 dark:text-white py-8">Card with link and image</h2>
...
<h2 class="text-2xl w-full mt-8 dark:text-white py-8">Card with image</h2>
...
<h2 class="text-2xl w-full mt-8 dark:text-white py-8">Card with red button</h2>
...
<h2 class="text-2xl w-full mt-8 dark:text-white py-8">Card with yellow button</h2>
...
<h2 class="text-2xl w-full mt-8 dark:text-white py-8">Card with purple button</h2>
