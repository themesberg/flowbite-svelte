...
<form class="flex">
  <div class="relative">
    <Button class="bg-neutral-secondary-medium text-body border border-default-medium hover:bg-neutral-tertiary-medium hover:text-heading rounded-e-none border-e-0 whitespace-nowrap">
      {selectCategory}
