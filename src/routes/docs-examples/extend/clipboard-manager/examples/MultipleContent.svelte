...
<div class="space-y-2">
  <div class="selectable-area border border-gray-200 bg-green-100 text-gray-600 p-4" id="content1">
    <p>Content area 1 with class="selectable-area"</p>
    <p>You can select from this div.</p>
  </div>

  <div class="non-selectable-area border border-gray-200 bg-red-100 text-gray-600 p-4" id="content2">
    <p>Content area 2 with class="non-selectable-area"</p>
    <p>You CAN'T select from this div.</p>
  </div>

  <div class="selectable-area border border-gray-200 bg-green-100 text-gray-600 p-4" id="content3">
