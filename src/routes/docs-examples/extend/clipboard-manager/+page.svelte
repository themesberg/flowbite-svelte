...
<div id="clipboard-example" class="mx-auto max-w-7xl space-y-8 p-6">
  ...
  <section class="space-y-6">
    ...
    <div class="rounded-base space-y-3 p-6 shadow">
      <div class="flex items-center gap-3">
        <span class="bg-neutral-tertiary text-heading rounded px-2.5 py-0.5 text-xs font-semibold">Custom</span>
  ...
  <section class="rounded-base space-y-4 p-6 shadow">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
      <div class="border-l-4 border-green-500 pl-4">
        ...
        <List class="text-body space-y-1 text-sm">
  ...
  <section class="rounded-base p-6">
    ...
    <p class="text-body mt-4 text-center text-sm">
