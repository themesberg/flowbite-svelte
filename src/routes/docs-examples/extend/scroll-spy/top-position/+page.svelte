...
<!-- You may need to add an id to your scrollable container -->
  ...
  <div class="min-h-screen dark:bg-gray-900">
    ...
    <main class="container mx-auto px-4 py-8">
      ...
      <section id="introduction" class="min-h-[800px] border">
        <h1 class="mb-6 text-4xl font-bold text-gray-900 dark:text-white">ScrollSpy Component</h1>
        <p>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officiis iure eius ex tenetur? Dolorum, nostrum corrupti? Est, labore nesciunt nihil veritatis tenetur quod quo! Eligendi tenetur
          architecto tempore at quam?
        </p>
<p>
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officiis iure eius ex tenetur? Dolorum, nostrum corrupti? Est, labore nesciunt nihil veritatis tenetur quod quo! Eligendi tenetur
          architecto tempore at quam?
...
<p>
      ...
      <section id="installation" class="min-h-[800px] border">
...
<p>
      ...
      <!-- Basic Usage Section -->
      <section id="basic-usage" class="min-h-[800px] border">
...
<p>
      ...
      <section id="features" class="min-h-[800px] border">
...
<p>
      ...
      <!-- Props Section -->
      <section id="props" class="min-h-[800px] border">
...
<p>
      ...
      <section id="accessibility" class="min-h-[800px] border">
