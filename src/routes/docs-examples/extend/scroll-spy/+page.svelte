...
<div class="{isFlex ? 'flex' : ''} bg-neutral-primary-soft pb-32">
  ...
  <main class="container mx-auto px-4 pb-8 {mainMarginClass}">
    ...
    <section id="installation" class="border-default border-t px-4 py-8">
    ...
    <section id="basic-usage" class="px-4 pb-16">
      ...
      <P class="text-body mb-6">The simplest way to use ScrollSpy is to provide an array of navigation items:</P>
    ...
    <section id="features" class="px-4 pb-16">
      ...
      <h3 class="text-heading mb-4 text-2xl font-semibold">Custom Positioning</h3>
      <p class="text-body mb-4">You can position the navigation on the top, left, or right:</p>
      <HighlightSvelte code={exampleModules["./md/position.md"] as string} langtag --langtag-color="orange" class="mb-4" />

      <h3 class="text-heading mb-4 text-2xl font-semibold">Offset for Fixed Headers</h3>
      ...
      <h3 class="text-heading mb-4 text-2xl font-semibold">Custom Active Styling</h3>
      <p class="text-body mb-4">Customize the appearance of active navigation items:</p>
        ...
        <table class="w-full border-collapse text-left">
          <thead>
            <tr class="border-default border-b">
              <th class="text-heading px-4 py-3 font-semibold">Prop</th>
              <th class="text-heading px-4 py-3 font-semibold">Type</th>
              <th class="text-heading px-4 py-3 font-semibold">Default</th>
              <th class="text-heading px-4 py-3 font-semibold">Description</th>
            </tr>
          </thead>
    ...
    <section id="accessibility" class="px-4 pb-16">
      ...
      <p class="text-body mb-6">The ScrollSpy component is built with accessibility in mind:</p>
      <ul class="text-body space-y-4">
